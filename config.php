...
return [
   "display_errors" => true,
   "https" => true,
   "private_hash" => "7c3d10b16d1f3e65548a31171fc341b9",
   "private_hex" => "a5c4fe3b3d71f79e7bf8b3f5215dce07",
   "feed_ads_key" => "1056945837",
   "cron_key" => "6472440769",
   "api_key" => "6433770502",
   "folder_admin" => "cp_650b2faddefa3",
   "basePath" => __dir__,
   "urlPrefix" => "/",
   "urlPath" => "https://yo.kg",
   ...
   "sms_services" => [
        ...
        "nikita.kg" => [ "url" => "https://smspro.nikita.kg", "param" => "login:pass", "country" => "Кыргызстан", "label" => true ],
   ],
