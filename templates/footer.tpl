   ...
   <div class="row" >
     ...
     <div class="col-lg-9 col-12" >
        ...
        <div class="footer-list-link" >
          <a href="<?php echo _link("rules"); ?>"><?php echo $ULang->t("Правила сервиса"); ?></a>
          <a href="<?php echo _link("user-agreement"); ?>"><?php echo $ULang->t("Пользовательское соглашение"); ?></a>
          <a href="<?php echo _link("feedback"); ?>"><?php echo $ULang->t("Служба поддержки"); ?></a>
        </div>
     ...
     <div class="col-lg-3 col-12" >
            ...
            <div class="footer-list-social" >
              <a class="social-icon" href="#">
                 <img src="<?php echo $settings["path_tpl_image"]; ?>/visa.svg">
               </a>
               <a class="social-icon" href="#">
                  <img src="<?php echo $settings["path_tpl_image"]; ?>/mastercard.svg">
                </a>
                <a class="social-icon" href="#">
                   <img src="<?php echo $settings["path_tpl_image"]; ?>/elcard.svg">
                 </a>
